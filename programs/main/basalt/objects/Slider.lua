        ...
        draw = function(self)
            ...
            self:addDraw("slider", function()
                ...
                if (barType == "horizontal") then
                    --local knobPos = (index / (barType == "vertical" and h or w)) * maxValue
                    ...
                    --self:addText(knobPos, oby, symbol:rep(symbolSize))
                    --if(symbolBG~=false)then self:addBG(knobPos, 1, tHex[symbolBG]:rep(#symbol*symbolSize)) end
                    --if(symbolFG~=false)then self:addFG(knobPos, 1, tHex[symbolFG]:rep(#symbol*symbolSize)) end
                end
